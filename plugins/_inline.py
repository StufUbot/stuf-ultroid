...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/StufUbot/stuf-ultroid"),
        Button.url("• Support •", url="t.me/kalijogo"),
    ],
]
...
async def inline_alive(o):
    ...
    WEB0 = InputWebDocument(
        "https://telegra.ph/file/6c85a9dc8efb112ba7274.jpg", 0, "image/jpg", []
    )
    RES = [
